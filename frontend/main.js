...
function buildTourSteps() {
  return [
    { key: "draws", title: "抽卡次数", text: "抽卡次数用来开启记忆晶核。注册初始获得 3 次；之后每日首次登录 +3，也能通过分享任务、累计开包返利、彩蛋组合和 24 点成功获得。" },
    { key: "score", title: "积分", text: "积分是排行榜核心。抽到新卡会提升积分，稀有度越高积分越多。" },
    { key: "collection", title: "收集", text: "收集表示你已经解锁的卡牌数量。馆藏共 54 张，收集越多，越容易凑齐彩蛋组合并提升排行榜竞争力。" },
    ...
    { key: "album", title: "卡册", text: "卡册是你的梗档案馆。收集新卡会增加积分、提升排行榜名次；集齐指定彩蛋组合会自动触发额外奖励。" },
  ...
  $("#modalContent").innerHTML = `
    <div class="guide">
      ...
      <div class="guide-grid">
        <div>
          <strong>抽卡次数</strong>
          <p>用于开启记忆晶核。注册初始获得 3 次；之后每日首次登录 +3，也可通过分享任务、累计开包返利、彩蛋组合和 24 点成功获得。</p>
        </div>
        <div>
          <strong>积分</strong>
        ...
        <div>
          <strong>收集</strong>
          <p>表示你已经解锁的卡牌数量。馆藏共 54 张，收集越多，越容易凑齐彩蛋组合并提升排行榜竞争力。</p>
        </div>
        <div>
          <strong>碎片</strong>
      ...
      <div class="guide-ranking">
        ...
        <p>注册初始获得 3 次；之后每日首次登录 +3。每天第一次点击任意分享入口、今日抽满 3 次、累计开包达到 10/30/50 次、集齐指定彩蛋组合，以及选中的 3 张卡成功凑出 24 点，都会奖励抽卡次数。</p>
      </div>
      <div class="guide-ranking">
        <strong>彩蛋组合奖励</strong>
        <p>彩蛋组合必须集齐指定的 3 张卡才会触发，不是任意同系列卡。当前组合包括和平精英、英雄联盟手游、金铲铲之战三组。</p>
      </div>
    </div>
  `;
  $("#modal").classList.remove("hidden");
